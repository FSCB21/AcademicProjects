...
function GenerarCampo() {
    ...
    newCell.textContent = formatterPeso.format(Sueldo_Dias().toFixed(0));

    newCell = newRow.insertCell(6);
    newCell.textContent = formatterPeso.format(Aux_Transporte().toFixed(0));

    newCell = newRow.insertCell(7);
    newCell.textContent = formatterPeso.format(Total_Devengado().toFixed(0));

    newCell = newRow.insertCell(8);
    newCell.textContent = formatterPeso.format(Salud().toFixed(0));

    newCell = newRow.insertCell(9);
    newCell.textContent = formatterPeso.format(Pension().toFixed(0));

    newCell = newRow.insertCell(10);
    newCell.textContent = formatterPeso.format(Total_Deducido().toFixed(0));

    newCell = newRow.insertCell(11);
    newCell.textContent = formatterPeso.format(Neto().toFixed(0));

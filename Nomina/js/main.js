...
function GenerarCampo() {
    ...
    /* let Nombre = form.Name.value;
     let TipoDoc = form.TipD.value;
     let Docu = form.Document.value;
     let Salario = form.salary.value;
     let DiasT = form.Days.value
 
 
     let mensaje = "El usuario se llama: " + Nombre +
         "Tiene: " + TipoDoc +
         "con el numero: " + Docu +
         "el cual tiene un salario de: " + Salario +
         "y trabaja " + DiasT + " dias al mes";
     console.log(mensaje)
 
    document.getElementById("nombre").innerHTML = Nombre;
     document.getElementById("TipoD").innerHTML = TipoDoc;
     document.getElementById("Documento").innerHTML = Docu;
     document.getElementById("Sueldo").innerHTML = Salario;
     document.getElementById("Dias").innerHTML = DiasT;*/


    //objeto al cual le pasamos un formulario como parametro y su contructor se encarga de crear un objeto con los datos del formulario
